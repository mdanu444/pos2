...
@endif
        ...
        <div class="table-responsive">
            ...
            @else
            {!! Form::model($data, ['route' => ['admins.update', $data->id], 'method' => 'put']) !!}
            @endif
            ...
            <div class="form-group d-flex">
                <div class="d-inline-block w-25">Password</div>
                {!! Form::password('password', ['placeholder' => 'Password', 'class' => 'form-control d-inline-block w-50']) !!}
            </div>
